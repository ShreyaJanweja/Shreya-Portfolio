      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center text-xl">
            <a href="mailto:shreya@example.com" className="group flex items-center gap-3 hover:text-neon-cyan transition-colors">
              <span>✉️ shreya@example.com</span>
            ...
            <a href="https://linkedin.com/in/shreya" target="_blank" className="group flex items-center gap-3 hover:text-blue-400 transition-colors">
              <span>💼 LinkedIn</span>
            ...
            <a href="https://github.com/shreya" target="_blank" className="group flex items-center gap-3 hover:text-gray-300 transition-colors">
              <span>🐱 GitHub</span>
